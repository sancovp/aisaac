...
(function() {
  ...
  if (!document.getElementById('exit-popup-styles')) {
    ...
    style.textContent = ''
      ...
      + '.ep-tag{font-family:ui-monospace,"SF Mono",Menlo,monospace;font-size:0.62rem;letter-spacing:0.14em;text-transform:uppercase;color:#B23F0F;margin-bottom:1.2rem;}'
      ...
      + '.ep-countdown{font-family:ui-monospace,"SF Mono",Menlo,monospace;font-size:0.75rem;letter-spacing:0.1em;color:#B23F0F;margin-bottom:1.4rem;}'
      ...
      + '.ep-offer.ep-feature{border-color:#B23F0F;background:rgba(178,63,15,0.05);}'
      + '.ep-offer-label{font-family:ui-monospace,"SF Mono",Menlo,monospace;font-size:0.58rem;letter-spacing:0.12em;text-transform:uppercase;color:#B23F0F;margin-bottom:0.4rem;display:block;}'
      ...
      + '.ep-offer-cta{font-family:ui-monospace,"SF Mono",Menlo,monospace;font-size:0.58rem;letter-spacing:0.1em;text-transform:uppercase;color:#B23F0F;}'
      + '.ep-scarcity{font-size:0.72rem;color:#8C300A;margin-top:0.5rem;font-style:italic;}'
      ...
      + '.ep-search:hover{color:#1D1A15;border-color:#B23F0F;}'
  ...
  if (!document.getElementById('exit-popup-templates')) {
    ...
    tpl.innerHTML = ''
      ...
      +   '<p class="ep-sub">If you really, really want to work with me, and you&rsquo;re really ready to take action to transform your life or business with AI collaboration, I saved <a class="ep-expired-link" href="#" style="color:#B23F0F;">the mastermind</a> for you.</p>'
