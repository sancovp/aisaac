...
(function() {
  ...
  if (!document.getElementById('exit-popup-styles')) {
    ...
    style.textContent = ''
      ...
      + '#exit-popup-box .ep-close{position:absolute;top:1rem;right:1.2rem;background:none;border:none;color:rgba(255,255,255,0.4);font-size:1.6rem;cursor:pointer;line-height:1;}'
      + '#exit-popup-box .ep-close:hover{color:rgba(255,255,255,0.9);}'
  ...
  if (!document.getElementById('exit-popup-templates')) {
    ...
    tpl.innerHTML = ''
      ...
      +   '<p class="ep-sub">If you really, really want to work with me, and you&rsquo;re really ready to take action to transform your life or business with AI collaboration, I saved <a class="ep-expired-link" href="#" style="color:#7dd3fc;">the mastermind</a> for you.</p>'
